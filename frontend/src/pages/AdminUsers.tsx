          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="border-b border-slate-100 hover:bg-slate-50">
                <td className="py-4 px-6 text-slate-900">#1</td>
                <td className="py-4 px-6 text-slate-900">John Doe</td>
                <td className="py-4 px-6 text-slate-600">john@example.com</td>
              ...
              <tr className="border-b border-slate-100 hover:bg-slate-50">
                <td className="py-4 px-6 text-slate-900">#2</td>
                <td className="py-4 px-6 text-slate-900">Jane Smith</td>
                <td className="py-4 px-6 text-slate-600">jane@example.com</td>
                <td className="py-4 px-6">
                  <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-semibold">
                    Active
                  </span>
