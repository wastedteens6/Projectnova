...
export default function AdminUsers() {
  ...
  const handleResetMFA = async (userId: string, name: string) => {
    ...
    try {
      await axios.patch(`${API}/auth/users/${userId}/reset-mfa`, {}, { headers: { Authorization: `Bearer ${token}` } })
  ...
  const handleUnlock = async (userId: string, name: string) => {
    ...
    try {
      await axios.patch(`${API}/auth/users/${userId}/unlock`, {}, { headers: { Authorization: `Bearer ${token}` } })
