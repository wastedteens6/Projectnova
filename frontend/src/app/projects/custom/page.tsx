        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className={`p-8 rounded-xl border transition-all duration-300 ${
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                className="group relative flex-1 px-8 py-4 font-bold text-lg transition-all duration-300"
              >
              ...
              <button
                ...
                className={`px-8 py-4 font-bold text-lg rounded-lg border-2 transition-all duration-300 ${
                  isLight
