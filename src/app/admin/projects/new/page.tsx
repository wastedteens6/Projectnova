...
import { ArrowLeft, Loader2, Plus, X, Upload, Play, Image as ImageIcon } from 'lucide-react';
...
export default function NewProjectPage() {
    ...
    const [form, setForm] = useState({
        ...
        features: [] as string[],
        tier1Price: '',
        tier1Features: [] as string[],
        tier1DriveId: '',
        tier2Price: '',
        tier2Features: [] as string[],
        tier2DriveId: '',
        tier3Price: '',
        tier3Features: [] as string[],
        tier3DriveId: '',
        isPublished: false,
        images: [] as string[],
        videoUrl: '',
                ...
                <Card className="glass-card">
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input value={form.title} onChange={(e) => handleTitleChange(e.target.value)} placeholder="E-Commerce MERN Stack" required />
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-medium">Slug *</label>
                            <Input value={form.slug} onChange={(e) => set('slug', e.target.value)} placeholder="e-commerce-mern-stack" required />
                            <p className="text-xs text-muted-foreground">Auto-generated from title. Lowercase, hyphens only.</p>
                        </div>
                        <div className="space-y-2">
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    min="1"
                                    step="1"
                                    value={form[`tier${tier}Price`]}
                                    onChange={(e) => set(`tier${tier}Price`, e.target.value)}
                                    placeholder="4999"
                                    required
                                />
                            </div>
                            ...
                            <TagInput
                                ...
                                value={form[`tier${tier}Features`]}
                                onChange={(v) => set(`tier${tier}Features`, v)}
                            />
                        </CardContent>
                    </Card>
                ))}
                ...
                <Card className="glass-card">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-xs text-muted-foreground">Max 5MB per image. Recommended size: 1280x720.</p>
                        </div>
                            ...
                            {form.videoUrl ? (
                                <div className="relative aspect-video rounded-xl overflow-hidden border border-border bg-black/20">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-4 right-4 p-2 rounded-full bg-destructive text-white hover:bg-destructive/90 transition-colors shadow-lg"
                                    >
                                        <X className="h-4 w-4" />
                                    </button>
                                </div>
                    ...
                    <CardContent className="pt-6">
                        <label className="flex items-center gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">Make this project visible to customers</p>
                            </div>
                        </label>
                    </CardContent>
                </Card>
